...
def load_data(source_flag, target_flag):
    ...
    target_data = np.load(
        ...
        "../splits/dermanist_splits.npz"
    )
    # TODO: need to change how data is loaded.
    trainset = MyDataset(
        target_data["train_images"][target_data["train_idx_run3_split-50pct"]],
        target_data["train_labels"][target_data["train_idx_run3_split-50pct"]],
